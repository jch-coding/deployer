...
it('can be associated to many interfaces', function () {
    ...
    expect($lacp_profile->interfaces)->toHaveCount(2)
        ->and($lacp_profile->interfaces->contains($interface1))->toBeTrue()
        ->and($lacp_profile->interfaces->contains($interface2))->toBeTrue();
});
