...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(DeviceDetailsController::class)->group(function () {
        ...
        Route::get('/device-details/deployments/{deployment}/devices', 'deploymentDevices')->name('device-details.deployments.devices');
    ...
    Route::controller(TaskController::class)->group(function () {
        ...
        Route::post('/tasks/{task}/extend', 'extend')->name('tasks.extend');
