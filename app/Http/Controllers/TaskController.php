...
class TaskController extends Controller
{
    ...
    private $core_vlans = [
        ['vlan' => 2, 'name' => 'Voice', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 3, 'name' => 'Visitor', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 4, 'name' => 'Freezer_Voice', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 6, 'name' => 'WCDAGV', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 7, 'name' => 'AGVMGMT', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 8, 'name' => 'WCDLAN', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 10, 'name' => 'WCDWLAN', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 12, 'name' => 'WCDTM', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 14, 'name' => 'WCDLOG', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 16, 'name' => 'TJLAN', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 17, 'name' => 'TJWLAN', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 20, 'name' => 'AccessControl', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 21, 'name' => 'ProdMGMT', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 22, 'name' => 'WCDSVR', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 23, 'name' => 'WCD_PI', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 24, 'name' => 'WCDKitchen', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 25, 'name' => 'BCP', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 28, 'name' => 'BananaRipening', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 30, 'name' => 'APMGMT', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 40, 'name' => 'RFID', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 42, 'name' => 'RF', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 60, 'name' => 'TEMPSENSOR', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 176, 'name' => 'Replication', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 199, 'name' => 'vMotion', 'igmp' => ['enable' => true, 'version' => 3]],
    ];

    private $access_vlans = [
        ['vlan' => 2, 'name' => 'Voice', 'igmp' => ['enable' => true, 'version' => 3], 'voice-enable' => true],
        ['vlan' => 3, 'name' => 'Visitor', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 4, 'name' => 'Freezer_Voice', 'igmp' => ['enable' => true, 'version' => 3], 'voice-enable' => true],
        ['vlan' => 6, 'name' => 'WCDAGV', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 8, 'name' => 'WCDLAN', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 10, 'name' => 'WCDWLAN', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 12, 'name' => 'WCDTM', 'igmp' => ['enable' => true, 'version' => 3]],
    ...
    private $dmz_vlans = [
        ['vlan' => 700, 'name' => 'WAN', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 815, 'name' => 'Internet 1', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 816, 'name' => 'Internet 2', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 915, 'name' => 'Internet 3', 'igmp' => ['enable' => true, 'version' => 3]],
        ['vlan' => 916, 'name' => 'Internet 4', 'igmp' => ['enable' => true, 'version' => 3]],
    ];
